...
```
あなた: 「ドラゴンを倒して」
主人公: 「...どこにいるかわかりません。ドラゴンの場所をどのように調査しますか？」
```

主人公はドラゴンの居場所を知りません。

あなたは主人公と一緒に試行錯誤し、ようやく火山にあるドラゴンの巣穴を探し出します。
...
| 機能 | 例 | 役割 | 説明 |
|------|----|------| ----|
| **Command** | `/attack` | 何をやるか？ | タスク、CLIコマンドを書く |
...
| **Rules** | 道の看板 | エリア（パス）ごとの自動適用ルール。そのパスでの前提条件 |
| **Command** | コマンド /attack, /hunt | 何をやるか。よく使う指示をまとめる。 |
| **Skill** | サンダー魔法、道案内 | どうやるか。複雑な手順や専門知識を定義する |
