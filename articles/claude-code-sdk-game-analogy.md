...
- Claude Code に興味があるが、概念がよくわからない人
- Command、Skill、Subagent、Rulesの違いを直感的に理解したい人
- AIエージェントの設計を学びたい人
...
Claude Code SDKでは、`.claude/agents/` にサブエージェントを定義します：
...
これがClaude Code SDKでいう**Rules（ルール）** です。
